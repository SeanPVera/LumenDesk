...
enum MusicModeHelp {
    ...
    static let effectIntensity = "How strongly rhythmic accents lift above the resting light. At zero, slow loudness and the selected movement still shape the room."
    ...
    static let minimumBrightness = "The resting floor before overall brightness scales the show. Raise it if the room keeps going too dark. Overall brightness at zero turns the show dark."
    ...
    static let phraseAware = "Adds a slow lift when energy rises and stays high. This is an energy comparison, not reliable verse or chorus recognition."
