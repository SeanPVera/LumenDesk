...
enum LightingCatalog {
    ...
    static let effects: [LightingEffect] = [
        ...
        effect("music-pulse", "Soundcheck", "Brightness and color punch to the music heard by your Mac.", "music.note.list", .musicPulse, [0xFF3B9D, 0x7D5CFF, 0x16D9D0, 0xFFB52E], 0.09, audio: true, energy: true),
