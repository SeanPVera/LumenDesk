...
enum LightingCatalog {
    ...
    static let effects: [LightingEffect] = [
        ...
        effect("fireflies", "Firefly Field", "Golden sparks wink on and off over a deep forest green.", "sparkles", .twinkle, [0xFFE57A, 0xB8E36D, 0x315C3A, 0x142D24], 0.18),
        effect("music-pulse", "Soundcheck", "Analyzes Apple Music/system audio for beats, drums, percussion, mood, and energy. On iPhone and iPad it listens through the microphone.", "music.note.list", .musicPulse, [0xFF3B9D, 0x7D5CFF, 0x16D9D0, 0xFFB52E], 0.09, audio: true, energy: true),
