...
enum LightingCatalog {
    ...
    static let effects: [LightingEffect] = [
        ...
        effect("music-pulse", "Soundcheck", "Analyzes Apple Music/system audio for beats, drums, percussion, mood, and energy while the microphone auto-calibrates the room.", "music.note.list", .musicPulse, [0xFF3B9D, 0x7D5CFF, 0x16D9D0, 0xFFB52E], 0.09, audio: true, energy: true),
